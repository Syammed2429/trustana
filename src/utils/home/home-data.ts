...
export const PAGE_CONFIG = {
  ...
  subtitle: "Advanced product data filtering and exploration with complex query operators, shareable filters, and powerful analytics.",
  advancedFeaturesTitle: "Advanced Features",
  advancedFeaturesDescription: "Built for senior frontend engineers with enterprise-grade requirements",
