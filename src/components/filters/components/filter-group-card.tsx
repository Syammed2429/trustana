...
interface FilterGroupCardProps {
  ...
  onAddCondition: () => void;
  onRemoveGroup: () => void;
  onConditionChange: (conditionId: string, updates: Partial<FilterCondition>) => void;
  onRemoveCondition: (conditionId: string) => void;
  onAttributeChange: (conditionId: string, attribute: string) => void;
}

export const FilterGroupCard: FC<FilterGroupCardProps> = memo(function FilterGroupCard({
  group,
  availableAttributes,
  canRemove,
  onNameChange,
      ...
      <CardHeader>
        <div className='flex items-center justify-between'>
          <div className='flex items-center gap-2'>
            ...
            />
            <Select value={group.logicalOperator} onValueChange={onLogicalOperatorChange}>
        ...
        <div className='space-y-3'>
          {group.conditions.map((condition, conditionIndex) => (
            <FilterConditionItem
              ...
              onAttributeChange={(attribute) => onAttributeChange(condition.id, attribute)}
              ...
              onValueChange={(value) => onConditionChange(condition.id, { value })}
          ...
          {group.conditions.length === 0 && (
            <div className='text-muted-foreground py-8 text-center'>
              No conditions added. Click &ldquo;Add Condition&rdquo; to start building your filter.
            </div>
          )}
        </div>
      </CardContent>
