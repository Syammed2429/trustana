...
export const metadata: Metadata = {
  ...
  description: "Advanced product data filtering and exploration with complex query operators, shareable filters, and powerful analytics. Built for enterprise-grade requirements.",
  keywords: [
    "product dashboard",
    "data filtering",
    "advanced search",
